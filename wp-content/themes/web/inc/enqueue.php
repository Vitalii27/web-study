...
function get_js() {
	...
	wp_enqueue_script('instagram-api', get_template_directory_uri() . '/js/instagram.js', array(), "", "in_footer");
	wp_enqueue_script('instagram-slider', get_template_directory_uri() . '/js/instagram-gallery.js', array(), "", "in_footer");
